...
6. **[Wu Xing Leibniz YingYang Tetragrams.png](Wu%20Xing%20Leibniz%20YingYang%20Tetragrams.png)**
...
1. **[RCM.pdf](RCM.pdf)**
2. **[Allen component.SLDPRT](Allen%20component.SLDPRT)**
3. **[Base parts 1.png](Base%20parts%201.png)**
4. **[Base parts 2.png](Base%20parts%202.png)**
5. **[Base parts 3.png](Base%20parts%203.png)**
...
1. (30-5-26) first release. (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v1.0.0)
2. (1-6-26) Banned on reddit so please share, also Added [RC simple coil, RC split ring resonator, RC thin wire raster drawing](#part-2-wu-xing-hardware-architecture-description) and added topics.
3. (2-6-26) Added **[Wu Xing Hardware Architecture.pdf](Wu%20Xing%20Hardware%20Architecture.pdf)**, added multiple drawings and cleaned up some mess see commits, did apeal two times but still shadowbanned on reddit, no responce about it either from mods, still no idea what happend further added [SOH fractals](#part-1-base-12-Microcosm-description), it did improve but they are still a bitt faulty, one should not expect a perfect SLDPRT.. on the macro scale it looks fine but it is incorrect on the micro scale. need to rework or redesign that later but improvements or fixes are welcome.>>
4. (3-6-26) Added **[The-Book-Of-Signs-Vol-i_text.pdf](The-Book-Of-Signs-Vol-i_text.pdf)** this is all i could find because most if it is lost media, i cannot scan in my personal collection at this moment so this must suffice for you all.
5. (4-6-26) Added The **[M.A.R.F. The Meta-Academic Response Framework.md](M.A.R.F.%20The%20Meta-Academic%20Response%20Framework.md)**, updated the **[Wu Xing Hardware Architecture.pdf](Wu%20Xing%20Hardware%20Architecture.pdf)** with the adding of a new section in the material roadmap about the Leibniz' Binary System and Shao Yong's "Yijing and another new section in the material roadmap called: The Wu Xing binary system, defined using π and reworked README to provide a more clear overvieuw.
6. (7-6-26) Added [The Asterion Perun Machine](#part-3-APM-description) and reworked readme.
7. (8-6-26) Deleted my reddit profile because of the ban and no responce even while being polite, i do not waste my time with them so i deleted my info since it has no purpose besides being a reminder and added 1st 9 day' report.png (moved to **[Report.pdf](Report.pdf)** ). ALEA IACTA EST!
8. (11-6-26) Made a new release under version 2.0.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v2.0.0)
9. (17-6-26) Buisy with something new, expect an update with some findings somewhere in the upcoming day's.
10. (18-6-26) I got approved to post on hackaday so the project is online there (https://hackaday.io/project/205951-vortex-anapole-confinement), also added **[Zodiac coil.png](Zodiac%20coil.png)** wich i forgot to add.
11. (19-6-26) Added [part 4 soyga](#part-4-soyga-description), including xlsx files for transparancy.
12. (21-6-26) Made a new release under version 2.1.0, (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v2.1.0) added the 2nd 9 day' report.png,9 day'reports.png (moved to **[Report.pdf](Report.pdf)** ) and **[Authors note 21-6-2026.md](Authors%20note%2021-6-2026.txt)** and updated readme accordingly VIVAT SOL ET IGNIS SACER!
13. (3-7-26) Added [part 5 RCM.](#part-5-RCM-description) electroculture apparatus blueprints, **[Justin Christofleau - Electroculture (English) - 1927.pdf](Justin%20Christofleau%20-%20Electroculture%20(english)%20-%201927.pdf)** to appendix, also adding a new chapter to the [soyga](#part-4-soyga-description), an update to that is incoming.
14. (4-7-26) Added the  3rd 9 day' report.png , 9 day'reports 2.png (moved to **[Report.pdf](Report.pdf)** ) and reworked the readme.
15. (15-7-26) Updated the [soyga](#part-4-soyga-description), now with the Collatz matrix included, made the [license](LICENSE) a dual license and reworked readme.
16. (16-7-26) Updated the [licenses](LICENSE) to AGPL-3.0-only and made shure i put it down as correctly as i could. also initiated contact with an local university in order to digitalize my personal collection of the works of G.H.Mees, this is is a personal effort to combat lost media.
17. (17-7-26) Added the 4th 9 day' report.png and 9 day'reports 3.png (moved to **[Report.pdf](Report.pdf)** ), a great thanks to all who are interested! <3. also made slight changes to repository, to remove bloat the .SLDDRW files are removed since there are also drawings and the sourcefiles present. a bitt overkill i would say..
18. (19-7-26) Made a new release under version 2.2.0. (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v2.2.0)
19. (24-7-26) Here is a rough digitalization of Mees Diagrams **[Mees Diagrams "The Book of Signs".pdf](Mees%20Diagrams%20''The%20book%20of%20signs''.pdf)**, this is from personal collection. PEACE PEACE PEACE!
20. (29-7-26) Added the 5th 9 day' report.png, and 9 day'reports 4.png (moved to **[Report.pdf](Report.pdf)** ).
21. (30-7-26) Updated the [soyga](#part-4-soyga-description) with a new chapter, also added **[Greek Collatz Soyga Matrix Blocks.xlsx](Greek%20Collatz%20Soyga%20Matrix%20Blocks.xlsx)** for people to look deaper into the logica from the new chapters, later reuploaded soyga.pdf due to an expansions in the last chapter. PS special mention to (missing link) for the first star on this repository! It means a lott and for people discovering this repository i would recomment to have a look at his work, also i changed the name of (formerly) material roadmap into **[Wu Xing Hardware Architecture.pdf](Wu%20Xing%20Hardware%20Architecture.pdf)** in part 2, seemed more appropriate. also did a heavy update to the readme with the additions of descriptions and lastly i updated the **[M.A.R.F. The Meta-Academic Response Framework.md](M.A.R.F.%20The%20Meta-Academic%20Response%20Framework.md)**
22. (31-7-26) Removed the special mention and referral from the README due to an update in repository stars, the referal link also gave a 404. Further now the release of v3.0.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v3.0.0)
...
32. (11-9-2026) New update of **[Wu Xing Hardware Architecture.pdf](Wu%20Xing%20Hardware%20Architecture.pdf)**, added whole new chapters and uploaded; **[Elements.png](Elements%20.png)**, **[Elements overvieuw.png](Elements%20overvieuw.png)**, **[Resistance 15 C.png](Resistance%2015%20C.png)**, **[Resistance -129.15 C.png](Resistance%20-129.15%20C.png)**, **[Wu Xing Leibniz YingYang Tetragrams.png](Wu%20Xing%20Leibniz%20YingYang%20Tetragrams.png)**, **[Wu Xing Leibniz Octet's.png](Wu%20Xing%20Leibniz%20Octet's.png)**,  **[Wu Xing Leibniz Final layer.png](Wu%20Xing%20Leibniz%20Final%20layer.png)**, **[Wu Xing Leibniz Complete.png](Wu%20Xing%20Leibniz%20Complete.png)**, **[Wu Xing Leibniz.png](Wu%20Xing%20Leibniz.png)** and **[Setun Setup Wu Xing.png](Setun%20Setup%20Wu%20Xing.png)**. Also now the official release of version v3.5.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v3.5.0)
33. (12-9-26) little fix, **[Wu Xing Hardware Architecture.pdf](Wu%20Xing%20Hardware%20Architecture.pdf)**
...
35. (19-9-26) Reworked and reuploaded **[Wu Xing Leibniz YingYang Tetragrams.png](Wu%20Xing%20Leibniz%20YingYang%20Tetragrams.png)** and **[Wu Xing Leibniz Octet's.png](Wu%20Xing%20Leibniz%20Octet's.png)**. The complete row will be fixed later on.
...
3. v2.1.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v2.1.0)
4. v2.2.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v2.2.0)
5. v3.0.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v3.0.0)
6. v3.5.0 (https://github.com/MadHatter-Auditor/vortex-anapole-confinement/releases/tag/v3.5.0)
